  ...
  return (
    <div className="space-y-6">
      ...
      <DurationSlider
        ...
        onChange={(v) => update("duration", clampDuration(v))}
        min={MIN_DURATION}
        max={MAX_DURATION}
        label="MP4 duration"
        helper="Longer videos give viewers more time to read. 8 seconds is recommended for Instagram Reels and Stories."
      />
